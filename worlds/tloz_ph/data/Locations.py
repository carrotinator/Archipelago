...
LOCATION_LIST: list[DSLocation] = [
    ...
    DSLocation("Mercay Shop Bomb Refill",
    ...
    DSLocation("Mercay Shop Red Potion",
               id=336,
               vanilla_item="Red Potion",
    ...
    DSLocation("Mercay Shop Purple Potion",
               id=358,
               vanilla_item="Purple Potion",
    ...
    DSLocation("Mercay Shop Treasure",
               id=337,
               vanilla_item="Treasure",
               region="Mercay Shop Buy",
               shop_model=True,
    ...
    DSLocation("Molida Shop Bomb Refill",
               vanilla_item="Refill: Bombs",
               # address=PHAddr.bomb_count,
               # value=0xa,
               value=0x1,
    ...
    DSLocation("Molida Shop Red Potion",
               id=340,
               vanilla_item="Red Potion",
        ...
        DSLocation("Molida Shop Purple Potion",
               id=359,
               vanilla_item="Purple Potion",
    ...
    DSLocation("Molida Shop Arrow Refill",
    ...
    DSLocation("Goron Shop Arrow Refill",
               vanilla_item="Refill: Arrows",
               # address=PHAddr.bomb_count,
               # value=0xa,
               value=0x1,
    ...
    DSLocation("Goron Shop Bombchu Refill",
    ...
    DSLocation("Beedle Shop Bottom Ship Part",
               id=348,
               vanilla_item="Ship Part",
               region="Beedle Shop",
               value=0x1,
    ...
    DSLocation("Beedle Shop Treasure",
               id=349,
               vanilla_item="Treasure",
               region="Beedle Shop",
               value=0x1,
    ...
    DSLocation("Beedle Shop Top Ship Part",
               id=350,
               vanilla_item="Ship Part",
               region="Beedle Bomb Bag",
               value=0x1,
    ...
    DSLocation("Masked Beedle Red Potion",
               id=352,
               vanilla_item="Red Potion",
               region="Beedle Shop",
               value=0x1,
    ...
    DSLocation("Masked Beedle Yellow Potion",
               id=353,
               vanilla_item="Yellow Potion",
               region="Beedle Shop",
               value=0x1,
    ...
    DSLocation("Masked Beedle Top Ship Part",
               id=354,
               vanilla_item="Ship Part",
               region="Beedle Shop",
               value=0x1,
    ...
    DSLocation("Masked Beedle Bottom Ship Part",
               id=355,
               vanilla_item="Ship Part",
               region="Beedle Shop",
               value=0x1,
    ...
    DSLocation("Masked Beedle Treasure",
               id=356,
               vanilla_item="Ship Part",
               region="Beedle Shop",
               value=0x1,
